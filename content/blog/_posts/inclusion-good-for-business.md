...
One way to do this from the outset is to recognize the [importance of language](https://www.bmc.com/blogs/2021-remote-work-considerations/) and how we use it in speech and the written word. As the world has changed, and awareness along with it, once-standard terminology is being retired and replaced with more inclusive language. So, what do we mean by that?
